...
\subsection{}
Let $n$ be a natural number. Prove that there are infinitely many solutions $(a,b,c)$ in $\mathbb{N}$ for:
$$a^2 + b^2 = c^n$$ where $(a^2 ,b^2, c^n)$ are coprime. Can you write a function to generate an arbitrary number of such triplets at will? (A generating function/expression). For example, if $n=2$ we can have $(a,b,c) = (k^2-1, 2k, k^2+1)$ etc

\subsection{Angles around a tetrahedron's corner}
...
\subsection{Descartes theorem (4 mutually touching circles)}
\subsubsection{}
...
\subsection{Sum of $k$-th powers of first $n$ natural numbers}
...
They're easy to verify on a calculator and have little purpose. But they're true. And they're tight. I just wanted to have some content between the problems and solutions so I got creative. These have nothing to do with anything.
\begin{align}
